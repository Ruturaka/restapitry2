...
public class OrderDaoImpl implements OrderDao {
    ...
    @Override
    public int updatePriceForId(Order order) {
        return jdbcTemplate.update("UPDATE orders SET price=menu.price FROM menu WHERE orders.dish=menu.dish AND orderid=?", new Object[]{order.getOrderid()});
    }
